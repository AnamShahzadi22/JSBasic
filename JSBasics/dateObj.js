...
console.log(newDate);
//local string not modify the new date it return the new string to show its result assign it to new variable 
let formattedDate = newDate.toLocaleString('default', {
    weekday: "long",
  });
  
  console.log(formattedDate); // Now you see the day name in long format
